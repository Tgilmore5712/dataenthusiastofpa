...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Led by a team of enthusiasts with years of experience in analytics, operations, leadership, and business solutions.",
  path: "/about",
});
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-6 py-16">
      ...
      <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700">
        Led by a team of enthusiasts with years of experience in analytics, operations, leadership, and business solutions, Data Enthusiast of PA builds practical automation systems, reporting platforms, and custom applications while enabling your team to own and scale what we implement.
      </p>
